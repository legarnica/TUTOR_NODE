...
// par y impares 
// función normal
function porDos(numero:number){
    return numero * 2
}
// función flecha (hagamos la misma para entender la flecha y lo que se cambia)

const porDoss = (number:number) => {
    return number * 2;
  };
// perame un poquito que me quedo sin batería xD
console.log(porDoss(3))

const porDosss = (number:number) => number * 2; // se puede ver que si resuelvo en una línea, no hace falta el return... pero son las tres funciones lo mismo... se entiende?siii
