...
// te fijas que los JSON (son los daots con los que llenamos el front)
// son complejos por que tienen objetos dentro de objetos.
// dentro del usuario hay direccion se entiende?
// por eso hacemos esto:

// package.lock eso significa 
// eso es lo que hace que la máquina lea tu package.json
// es el compilado lo crea la máquina. no lo debes tocar,
// si cambias tu .json  enctamienbdia o el 
// oks entonces el que yo haga esto:
interface Direccion {
    calle: string;
    ciudad: string;
    codigoPostal: string;
